...
`index.html` zeigt ausschließlich den Streamplan, den Light-/Dark-Mode-Toggle, öffentliche Social-/Plattform-Links und die Edelweiß-Grafiken. Es gibt keinen öffentlichen Admin-Link, keinen Login, keinen Token-Bereich und keine Bearbeitungslogik in den öffentlichen Dateien.
